...
public class XTabLayout extends HorizontalScrollView {
    ...
    static final int DEFAULT_TAB_SIZE = 14; //sp
    ...
    float mTabTextSize;
    float mTabSelectedSize;
    float mTabTextMultiLineSize;
    boolean mTabTextBold;
    ...
    public XTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textViewPaddingHorizontal = a.getDimensionPixelSize(R.styleable.XTabLayout_x_tabPaddingHorizontal,dpToPx(6));
        ...
        mTabTextSize = a.getDimensionPixelSize(
                R.styleable.XTabLayout_x_tabTextSize, sp2px(DEFAULT_TAB_SIZE));
        mTabSelectedSize = a.getDimensionPixelSize(R.styleable.XTabLayout_x_tabTextSelectedSize, sp2px(DEFAULT_TAB_SIZE));
        ...
        mTabTextBold = a.getBoolean(R.styleable.XTabLayout_x_tabTextBold, false);
        a.recycle();
    ...
    private void setSelectedTabView(int position) {
        ...
        if (position < tabCount) {
            for (int i = 0; i < tabCount; i++) {
                ...
                if ((int)Math.floor(mTabTextSize) != (int) Math.floor(mTabSelectedSize)){
                    if (i == position){
                        if (child instanceof TabView){
                            ((TabView)child).mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, mTabSelectedSize);
                        }
                    }else {
                        if (child instanceof TabView){
                            ((TabView)child).mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX,mTabTextSize);
                        }
                    }
                }
        ...
        final void update() {
            ...
            if (mCustomView == null) {
                ...
                if (mTextView == null) {
                    ...
                    textView.setPadding(textViewPaddingHorizontal,0,textViewPaddingHorizontal,0);
                    addView(textView);
                    mTextView = textView;
