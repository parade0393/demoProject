 ...
 */
public class FragmentLifeDetachActivity extends DemoActivity implements View.OnClickListener, BottomNavView.OnBottomViewItemSelectedListener, FragmentLifeListener {
    ...
    protected void initViews() {
        ...
        tv_title.setText("fg,transition,detach,attach");
        if (save != null) {
    ...
    private void updateFragment(int position) {
        ...
        if (position != oldPosition) {
            ...
            if (hideFragment != null) {
                ...
                fragmentTransaction.detach(hideFragment);
            }
