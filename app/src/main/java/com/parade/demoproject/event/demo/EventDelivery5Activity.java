...
public class EventDelivery5Activity extends DemoActivity implements FragmentLifeListener, View.OnClickListener {

    private TextView tv_content;
    private FrameLayout5 fl_group;
    private TextView1 tv_phone;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_event_delivery5);
    }
