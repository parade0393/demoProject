 ...
 * description :
 */
public class FrameLayout5 extends FrameLayout {

    private FragmentLifeListener mListener;

    public FrameLayout5(@NonNull Context context) {
        super(context);
    }

    public FrameLayout5(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public FrameLayout5(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
